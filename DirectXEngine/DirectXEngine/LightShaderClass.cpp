...
bool LightShaderClass::initializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//Get the count of the elements in the layout
	...
	//Create the constant buffer pointer so we can access the matrix constant buffer from within this class
	...
	//Not that ByteWidth always needs to be a multiple of 16 if using D3D11_BIND_CONSTANT_BUFFER or CreateBuffer will fail
	...
	//Create the constant buffer pointer so we can access the light constant buffer from within this class
...
void LightShaderClass::outputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	//Pop up a message on the screen to notify the user to check the text file for compile errors
...
bool LightShaderClass::setShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, 
	ID3D11ShaderResourceView* texture, XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor, XMFLOAT3 cameraPosition, 
	XMFLOAT4 specularColor, float specularPower)
{
	...
	//Geta pointer to the data in the constant buffer
