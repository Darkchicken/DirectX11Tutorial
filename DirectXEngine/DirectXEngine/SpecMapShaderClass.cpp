...
bool SpecMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = initializeShader(device, hwnd, L"../DirectXEngine/specmap.vs", L"../DirectXEngine/specmap.ps");
	if (!result)
	{
		return false;
	}
	...
	XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower)
{
	...
	result = setShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, 
		textureArray, lightDirection, diffuseColor, cameraPosition, specularColor, specularPower);
	if (!result)
	{
		return false;
	}
...
bool SpecMapShaderClass::initializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "SpecMapVertexShader", "vs_5_0",
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "SpecMapPixelShader", "ps_5_0",
...
void SpecMapShaderClass::outputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	//Pop a message up on the screen to notify the user to check the text file for errors
